        ...
        pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!session.isLoggedIn()) {
                    ...
                    startActivity(new Intent(Activity_ShopCard.this, Login.class));
                    ...
                    new MaterialStyledDialog.Builder(Activity_ShopCard.this)
                            ...
                            .onPositive(new MaterialDialog.SingleButtonCallback() {
                                ...
                                public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                    Intent intent = new Intent(Activity_ShopCard.this, Confirm_Phone.class);
        ...
        try {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                public void onErrorResponse(VolleyError error) {
                    Log.e("sendOrder E", error.toString());
                    hideDialog();
                    finish();
                }
            }) {
